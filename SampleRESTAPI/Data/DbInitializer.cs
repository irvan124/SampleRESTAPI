...
namespace SampleRESTAPI.Data
{
    public static class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            {
                new Student{FirstName="Morad",LastName="Hansen",EnrollmentDate=DateTime.Parse("2021-12-12")},
                new Student{FirstName="Walang",LastName="Jamir",EnrollmentDate=DateTime.Parse("2021-10-12")},
            ...
            var enrollments = new Enrollment[]
            {
                ...
                new Enrollment{StudentID=3, CourseID=1,Grade=Grade.C},
